...
class CantoCap {
  ...
  private createWindow(): void {
    ...
    this.mainWindow.webContents.on('console-message', ({ level, message, lineNumber, sourceId }: {
      ...
      if (message.includes('React') || message.includes('Maximum update depth') || message.includes('Error #185')) {
