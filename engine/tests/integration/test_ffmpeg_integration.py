...
from src.infrastructure.services import FFmpegService
from src.infrastructure.repositories import FFmpegAudioRepository
from src.domain.entities import MediaFile
...
class TestFFmpegIntegration:
    ...
    @patch('src.infrastructure.services.ffmpeg_service.ffmpeg')
